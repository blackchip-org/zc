...
func redo(r *Repl, _ []scan.Token) error {
	...
	r.undoStack = append([]zc.Stack[zc.Item]{r.Calc.Stack.Clone()}, r.undoStack...)
	r.Calc.Stack = r.redoStack[0]
...
func undo(r *Repl, _ []scan.Token) error {
	...
	r.redoStack = append([]zc.Stack[zc.Item]{r.Calc.Stack.Clone()}, r.redoStack...)
	r.Calc.Stack = r.undoStack[0]
