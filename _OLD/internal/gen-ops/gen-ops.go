...
var (
	...
	OpsDir  = path.Join(RootDir, "calc", "ops")
	TestDir = path.Join(RootDir, "calc", "test", "docs")
	VolDir  = path.Join(RootDir, "calc", "vols")
)
...
func genOps(vols []zc.VolDef) {
	for _, vol := range vols {
		...
		fmt.Fprintf(f, "\"github.com/blackchip-org/zc/v6/calc/funcs\"\n")
		fmt.Fprintf(f, "\"github.com/blackchip-org/zc/v6/calc/types\"\n")
		fmt.Fprintf(f, ")\n")
...
func genVols(vols []zc.VolDef) {
	for _, vol := range vols {
		...
		fmt.Fprintf(f, "import (\n")
		fmt.Fprintf(f, "\"github.com/blackchip-org/zc/v6\"\n")
		fmt.Fprintf(f, "\"github.com/blackchip-org/zc/v6/calc/ops\"\n")
		fmt.Fprintf(f, "\"github.com/blackchip-org/zc/v6/calc/types\"\n")
		fmt.Fprintf(f, ")\n")
