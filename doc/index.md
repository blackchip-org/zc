...
- add
  ...
  - [(time) add](ops/time.md#add): Time after a duration
- and
...
- [c-f](ops/unit.md#c-f): Celsius to Fahrenheit
- [c-k](ops/unit.md#c-k): Celsius to Kelvin
...
- [date](ops/time.md#date): Formats a date with the default layout
- [date-time](ops/time.md#date-time): Formats a datetime with the default layout
- [day-year](ops/time.md#date-year): Day of year for a given date
- [dec](ops/prog.md#dec): Convert to decimal
- [deca](ops/unit.md#deca): da, 1e01
- [deci](ops/unit.md#deci): d, 1e-01
...
- [dt](ops/time.md#date-time): Formats a datetime with the default layout
...
- [exa](ops/unit.md#exa): E, 1e18
- [exp](ops/sci.md#exp): Natural exponential

## f

- [f-c](ops/unit.md#f-c): Fahrenheit to Celsius
- [false](ops/bool.md#false): False
- [femto](ops/unit.md#femto): f, 1e-15
...
- [k-c](ops/unit.md#k-c): Kelvin to Celsius
- [kilo](ops/unit.md#kilo): k, 1e03
- [km-mi](ops/unit.md#km-mi): Kilometers to miles
- [km-nmi](ops/unit.md#km-nmi): Kilometers to nautical miles

## l

- [left](ops/text.md#left): Substring from the left
- [len](ops/text.md#len): Length
- [local-zone](ops/time.md#local-zone): Local time zone, set
- [local-zone=](ops/time.md#local=): Local time zone, get
...
- [m-nmi](ops/unit.md#m-nmi): Meters to nautical miles
- [map](ops/hof.md#map): Apply a function to each item on the stack
- [mega](ops/unit.md#mega): M, 1e06
- [mi-km](ops/unit.md#mi-km): Miles to kilometers
- [mi-nm](ops/unit.md#mi-nmi): Miles to nautical miles
- [micro](ops/unit.md#micro): μ, 1e-06
- [milli](ops/unit.md#milli): m, 1e-03
- [minutes](ops/time.md#minutes): Minutes in a duration
...
- [nano](ops/unit.md#nano): n, 1e-09
- [neg](ops/basic.md#neg): Negation
- [neq](ops/bool.md#neq): Not Equals
- [nmi-km](ops/unit.md#nmi-km): Nautical miles to kilometers
- [nmi-m](ops/unit.md#nmi-m): Nautical miles to meters
- [nmi-mi](ops/unit.md#nmi-mi): Nautical miles to miles
- not
  - [(bool) not](ops/bool.md#not): Negation
  - [(prog) not](ops/prog.md#not): Bitwise not
- [now](ops/time.md#now): Current date and time
- [now-restore](ops/time.md#now-restore): Cancel override of the value
- [now-set](ops/time.md#now-set): Override the value returned by `now`
...
- [peta](ops/unit.md#peta): P, 1e15
- [pi](ops/sci.md#pi): Circumference to diameter ratio
- [pico](ops/unit.md#pico): p, 1e-12
- [pow](ops/basic.md#pow): Exponentiation

## q

- [quecto](ops/unit.md#quecto): q, 1e-30
- [quetta](ops/unit.md#quetta): Q, 1e30
...
- [ronna](ops/unit.md#ronna): R, 1e27
- [ronto](ops/unit.md#ronto): r, 1e-27
...
- [tera](ops/unit.md#tera): T, 1e12
- [time](ops/time.md#time): Formats a time with the default layout
- [time-zone](ops/time.md#time-zone): Convert time to a given time zone
- [top](ops/stack.md#top): Keep the top of the stack and discard the rest
- [true](ops/bool.md#true): True
- [tz](ops/time.md#time-zone): Convert time to a given time zone
...
- [yocto](ops/unit.md#yocto): y, 1e-24
- [yotta](ops/unit.md#yotta): Y, 1e24
