...
var opsList = []zc.OpDecl{
	...
	zc.Macro("iec.convert", "div mul"),
	zc.Macro("iec.exbi", "2 60 pow"),
	zc.Macro("iec.gibi", "2 30 pow"),
	zc.Macro("iec.kibi", "2 10 pow"),
	zc.Macro("iec.mebi", "2 20 pow"),
	zc.Macro("iec.pebi", "2 50 pow"),
	zc.Macro("iec.tebi", "2 40 pow"),
	zc.Macro("iec.unit", "1"),
