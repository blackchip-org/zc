...
func TestDMS(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.fields.String(), func(t *testing.T) {
			dms, err := NewDMSFromFields(c, test.fields)
			if err != nil {
				t.Fatal(err)
			}
			deg, min, sec := dms.DMS()
...
func TestFormat(t *testing.T) {
	...
	tests := []struct {
		...
		{NewDMSFromFloat(c, 1, 0, 0), dms.SecUnit, -1, "1° 0′ 0″"},
		{NewDMSFromFloat(c, 1, 2, 0), dms.SecUnit, -1, "1° 2′ 0″"},
		{NewDMSFromFloat(c, 1, 2, 3.33), dms.SecUnit, -1, "1° 2′ 3.33″"},
		{NewDMSFromFloat(c, -1, 2, 3.33), dms.SecUnit, -1, "-1° 2′ 3.33″"},
		{NewDMSFromFloat(c, 1, -2, -3.33), dms.SecUnit, -1, "1° 2′ 3.33″"},
		{NewDMSFromFloat(c, 1, -2, -3.36), dms.SecUnit, 1, "1° 2′ 3.4″"},
		{NewDMSFromFloat(c, 1.051667, 0, 0), dms.SecUnit, -1, "1° 3′ 6.0012″"},
		{NewDMSFromFloat(c, -1.051667, 0, 0), dms.SecUnit, -1, "-1° 3′ 6.0012″"},
		{NewDMSFromFloat(c, 1.5, 0, 0), dms.SecUnit, -1, "1° 30′ 0″"},
		{NewDMSFromFloat(c, 1.5, 10, 0), dms.SecUnit, -1, "1° 40′ 0″"},
		{NewDMSFromFloat(c, -1.5, 10, 0), dms.SecUnit, -1, "-1° 40′ 0″"},
		{NewDMSFromFloat(c, -1.5, -10, 0), dms.SecUnit, -1, "-1° 40′ 0″"},
		{NewDMSFromFloat(c, 1.5, 10.5, 10), dms.SecUnit, -1, "1° 40′ 40″"},
		{NewDMSFromFloat(c, 0, 0, 75), dms.SecUnit, -1, "0° 1′ 15″"},
		{NewDMSFromFloat(c, 0, 10, 135), dms.SecUnit, -1, "0° 12′ 15″"},
		{NewDMSFromFloat(c, 0, 59, 135), dms.SecUnit, -1, "1° 1′ 15″"},

		{NewDMSFromFloat(c, 1, 0, 0), dms.MinUnit, 3, "1° 0.000′"},
		{NewDMSFromFloat(c, 1, 2, 0), dms.MinUnit, 3, "1° 2.000′"},
		{NewDMSFromFloat(c, 1, 2, 6), dms.MinUnit, 3, "1° 2.100′"},

		{NewDMSFromFloat(c, 1, 0, 0), dms.DegUnit, 6, "1.000000°"},
		{NewDMSFromFloat(c, 1, 3, 0), dms.DegUnit, 6, "1.050000°"},
		{NewDMSFromFloat(c, 1, 3, 9), dms.DegUnit, 6, "1.052500°"},
	}
